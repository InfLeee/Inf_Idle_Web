...
export const twoHandedSwordA1Config = {
  ...
  weapon: {
    ...
    fixedWeaponSkillIds: ["two_handed_sword_aura_blade", "two_handed_sword_breaker", "two_handed_sword_guard", "two_handed_sword_execution", "mount"],
  },
  build: {
  ...
  skills: [
    ...
    {
      id: "two_handed_sword_breaker",
      name: "崩山重斩",
      tags: ["DAMAGE", "PHYSICAL", "MELEE", "AREA", "WEAPON_SKILL", "TWO_HANDED_SWORD"],
      role: "burst",
      priorityOnly: true,
    ...
    {
      id: "two_handed_sword_guard",
      name: "守势反击",
      tags: ["DAMAGE", "PHYSICAL", "MELEE", "WEAPON_SKILL", "CONDITION", "TWO_HANDED_SWORD"],
      priorityOnly: true,
    ...
    {
      id: "two_handed_sword_execution",
      name: "断罪追击",
      tags: ["DAMAGE", "PHYSICAL", "MELEE", "WEAPON_SKILL", "HIGHLIGHT", "TWO_HANDED_SWORD"],
      role: "burst",
      priorityOnly: true,
      stats: { damageMultiplier: 1.6 },
      actionTimeMs: 850,
      cooldownMs: 8000,
      resourceCost: 100,
      activationResource: 100,
